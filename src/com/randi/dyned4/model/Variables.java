...
public class Variables {
	...
	public static final String CONVERSATION_CODE = "GE4";
	public static final String APP_NAME = "General English 4";
	public static final String APP_ID = "100004";

	public static final String SPLASH_NAME = "General English / 4";
